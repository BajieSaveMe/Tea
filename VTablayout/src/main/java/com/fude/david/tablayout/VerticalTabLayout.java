package com.fude.david.tablayout;
...
import com.fude.david.tablayout.adapter.TabAdapter;
import com.fude.david.tablayout.util.DisplayUtil;
import com.fude.david.tablayout.util.TabFragmentManager;
import com.fude.david.tablayout.widget.QTabView;
            ...
            if (mPagerAdapter instanceof TabAdapter) {
                ...
                for (int i = 0; i < adapterCount; i++) {
                    ...
                    addTab(new QTabView(mContext).setTitle(
                            new QTabView.TabTitle.Builder().setContent(title)
                                    .setTextColor(getResources().getColor(R.color.selectedColor), getResources().getColor(R.color.normalColor)).build()));
                }
            }
